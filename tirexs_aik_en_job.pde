...
if( beky < -1) 
{
 ...
 beky =beky+beksnelheid;
  ...
  rect(x +350,y - beky +250,50,50 + beky);
  ...
  if (keyCode == LEFT   && levens >0 ) { x = x - 1; }
  if (keyCode == DOWN   && levens >0 ) { y = y + 1; }
  if (keyCode == UP       && levens >0 )  { y = y - 1; }
  if (keyCode == RIGHT      && levens >0 )  { y = y - 1; }  
